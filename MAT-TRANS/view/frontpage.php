...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand ml-3" href="index.php?controller=Frontpage&method=index">MAT-TRANS</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5" style="color: white;" data-aos="fade-down" data-aos-delay="400">MAT-TRANS</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 h-100 text-center text-lg-left my-auto">
          ...
          <p class="text-muted small mb-4 mb-lg-0">&copy; MAT-TRANS <?php print(date("Y")); ?>. All Rights Reserved.</p>
        </div>
